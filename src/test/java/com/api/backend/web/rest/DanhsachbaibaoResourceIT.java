...
public class DanhsachbaibaoResourceIT {
    ...
    @Test
    @Transactional
    public void getAllDanhsachbaibaosByNhansutobaibaoIsEqualToSomething() throws Exception {
        // Initialize the database
        danhsachbaibaoRepository.saveAndFlush(danhsachbaibao);
        Nhansutobaibao nhansutobaibao = NhansutobaibaoResourceIT.createEntity(em);
        em.persist(nhansutobaibao);
        em.flush();
        danhsachbaibao.addNhansutobaibao(nhansutobaibao);
        danhsachbaibaoRepository.saveAndFlush(danhsachbaibao);
        Long nhansutobaibaoId = nhansutobaibao.getId();

        // Get all the danhsachbaibaoList where nhansutobaibao equals to nhansutobaibaoId
        defaultDanhsachbaibaoShouldBeFound("nhansutobaibaoId.equals=" + nhansutobaibaoId);

        // Get all the danhsachbaibaoList where nhansutobaibao equals to nhansutobaibaoId + 1
        defaultDanhsachbaibaoShouldNotBeFound("nhansutobaibaoId.equals=" + (nhansutobaibaoId + 1));
    }


    @Test
    @Transactional
    public void getAllDanhsachbaibaosByDetaitobaibaoIsEqualToSomething() throws Exception {
        // Initialize the database
        danhsachbaibaoRepository.saveAndFlush(danhsachbaibao);
        Detaitobaibao detaitobaibao = DetaitobaibaoResourceIT.createEntity(em);
        em.persist(detaitobaibao);
        em.flush();
        danhsachbaibao.addDetaitobaibao(detaitobaibao);
        danhsachbaibaoRepository.saveAndFlush(danhsachbaibao);
        Long detaitobaibaoId = detaitobaibao.getId();

        // Get all the danhsachbaibaoList where detaitobaibao equals to detaitobaibaoId
        defaultDanhsachbaibaoShouldBeFound("detaitobaibaoId.equals=" + detaitobaibaoId);

        // Get all the danhsachbaibaoList where detaitobaibao equals to detaitobaibaoId + 1
        defaultDanhsachbaibaoShouldNotBeFound("detaitobaibaoId.equals=" + (detaitobaibaoId + 1));
    }
