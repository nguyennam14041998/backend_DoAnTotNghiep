...
public class NhansuResourceIT {
    ...
    private static final Integer DEFAULT_NAMSINH = 1;
    private static final Integer UPDATED_NAMSINH = 2;
    private static final Integer SMALLER_NAMSINH = 1 - 1;
    ...
    @Test
    @Transactional
    public void getAllNhansusByNamsinhIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        nhansuRepository.saveAndFlush(nhansu);

        // Get all the nhansuList where namsinh is greater than or equal to DEFAULT_NAMSINH
        defaultNhansuShouldBeFound("namsinh.greaterThanOrEqual=" + DEFAULT_NAMSINH);

        // Get all the nhansuList where namsinh is greater than or equal to UPDATED_NAMSINH
        defaultNhansuShouldNotBeFound("namsinh.greaterThanOrEqual=" + UPDATED_NAMSINH);
    }

    @Test
    @Transactional
    public void getAllNhansusByNamsinhIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        nhansuRepository.saveAndFlush(nhansu);

        // Get all the nhansuList where namsinh is less than or equal to DEFAULT_NAMSINH
        defaultNhansuShouldBeFound("namsinh.lessThanOrEqual=" + DEFAULT_NAMSINH);

        // Get all the nhansuList where namsinh is less than or equal to SMALLER_NAMSINH
        defaultNhansuShouldNotBeFound("namsinh.lessThanOrEqual=" + SMALLER_NAMSINH);
    }

    @Test
    @Transactional
    public void getAllNhansusByNamsinhIsLessThanSomething() throws Exception {
        // Initialize the database
        nhansuRepository.saveAndFlush(nhansu);

        // Get all the nhansuList where namsinh is less than DEFAULT_NAMSINH
        defaultNhansuShouldNotBeFound("namsinh.lessThan=" + DEFAULT_NAMSINH);

        // Get all the nhansuList where namsinh is less than UPDATED_NAMSINH
        defaultNhansuShouldBeFound("namsinh.lessThan=" + UPDATED_NAMSINH);
    }

    @Test
    @Transactional
    public void getAllNhansusByNamsinhIsGreaterThanSomething() throws Exception {
        // Initialize the database
        nhansuRepository.saveAndFlush(nhansu);

        // Get all the nhansuList where namsinh is greater than DEFAULT_NAMSINH
        defaultNhansuShouldNotBeFound("namsinh.greaterThan=" + DEFAULT_NAMSINH);

        // Get all the nhansuList where namsinh is greater than SMALLER_NAMSINH
        defaultNhansuShouldBeFound("namsinh.greaterThan=" + SMALLER_NAMSINH);
    }
    ...
    @Test
    @Transactional
    public void getAllNhansusByNhansutobaibaoIsEqualToSomething() throws Exception {
        // Initialize the database
        nhansuRepository.saveAndFlush(nhansu);
        Nhansutobaibao nhansutobaibao = NhansutobaibaoResourceIT.createEntity(em);
        em.persist(nhansutobaibao);
        em.flush();
        nhansu.addNhansutobaibao(nhansutobaibao);
        nhansuRepository.saveAndFlush(nhansu);
        Long nhansutobaibaoId = nhansutobaibao.getId();

        // Get all the nhansuList where nhansutobaibao equals to nhansutobaibaoId
        defaultNhansuShouldBeFound("nhansutobaibaoId.equals=" + nhansutobaibaoId);

        // Get all the nhansuList where nhansutobaibao equals to nhansutobaibaoId + 1
        defaultNhansuShouldNotBeFound("nhansutobaibaoId.equals=" + (nhansutobaibaoId + 1));
    }
