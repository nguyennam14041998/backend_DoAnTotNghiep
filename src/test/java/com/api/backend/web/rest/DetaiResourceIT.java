...
public class DetaiResourceIT {
    ...
    private static final String DEFAULT_NHANSU = "AAAAAAAAAA";
    private static final String UPDATED_NHANSU = "BBBBBBBBBB";
    ...
    public void createDetai() throws Exception {
        ...
        assertThat(testDetai.getNam()).isEqualTo(DEFAULT_NAM);
        ...
        assertThat(testDetai.getNhansu()).isEqualTo(DEFAULT_NHANSU);
    ...
    public void getAllDetais() throws Exception {
        ...
        restDetaiMockMvc.perform(get("/api/detais?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].nhansu").value(hasItem(DEFAULT_NHANSU)))
    ...
    public void getDetai() throws Exception {
        ...
        restDetaiMockMvc.perform(get("/api/detais/{id}", detai.getId()))
            ...
            .andExpect(jsonPath("$.nhansu").value(DEFAULT_NHANSU))
    ...
    @Test
    @Transactional
    public void getAllDetaisByNamIsEqualToSomething() throws Exception {
        // Initialize the database
        detaiRepository.saveAndFlush(detai);

        // Get all the detaiList where nam equals to DEFAULT_NAM
        defaultDetaiShouldBeFound("nam.equals=" + DEFAULT_NAM);

        // Get all the detaiList where nam equals to UPDATED_NAM
        defaultDetaiShouldNotBeFound("nam.equals=" + UPDATED_NAM);
    }

    @Test
    @Transactional
    public void getAllDetaisByNamIsNotEqualToSomething() throws Exception {
        // Initialize the database
        detaiRepository.saveAndFlush(detai);

        // Get all the detaiList where nam not equals to DEFAULT_NAM
        defaultDetaiShouldNotBeFound("nam.notEquals=" + DEFAULT_NAM);

        // Get all the detaiList where nam not equals to UPDATED_NAM
        defaultDetaiShouldBeFound("nam.notEquals=" + UPDATED_NAM);
    }

    @Test
    @Transactional
    public void getAllDetaisByNamIsInShouldWork() throws Exception {
        // Initialize the database
        detaiRepository.saveAndFlush(detai);

        // Get all the detaiList where nam in DEFAULT_NAM or UPDATED_NAM
        defaultDetaiShouldBeFound("nam.in=" + DEFAULT_NAM + "," + UPDATED_NAM);

        // Get all the detaiList where nam equals to UPDATED_NAM
        defaultDetaiShouldNotBeFound("nam.in=" + UPDATED_NAM);
    }

    @Test
    @Transactional
    public void getAllDetaisByNamIsNullOrNotNull() throws Exception {
        // Initialize the database
        detaiRepository.saveAndFlush(detai);

        // Get all the detaiList where nam is not null
        defaultDetaiShouldBeFound("nam.specified=true");

        // Get all the detaiList where nam is null
        defaultDetaiShouldNotBeFound("nam.specified=false");
    }

    @Test
    @Transactional
    public void getAllDetaisByNamIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        detaiRepository.saveAndFlush(detai);

        // Get all the detaiList where nam is greater than or equal to DEFAULT_NAM
        defaultDetaiShouldBeFound("nam.greaterThanOrEqual=" + DEFAULT_NAM);

        // Get all the detaiList where nam is greater than or equal to UPDATED_NAM
        defaultDetaiShouldNotBeFound("nam.greaterThanOrEqual=" + UPDATED_NAM);
    }

    @Test
    @Transactional
    public void getAllDetaisByNamIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        detaiRepository.saveAndFlush(detai);

        // Get all the detaiList where nam is less than or equal to DEFAULT_NAM
        defaultDetaiShouldBeFound("nam.lessThanOrEqual=" + DEFAULT_NAM);

        // Get all the detaiList where nam is less than or equal to SMALLER_NAM
        defaultDetaiShouldNotBeFound("nam.lessThanOrEqual=" + SMALLER_NAM);
    }

    @Test
    @Transactional
    public void getAllDetaisByNamIsLessThanSomething() throws Exception {
        // Initialize the database
        detaiRepository.saveAndFlush(detai);

        // Get all the detaiList where nam is less than DEFAULT_NAM
        defaultDetaiShouldNotBeFound("nam.lessThan=" + DEFAULT_NAM);

        // Get all the detaiList where nam is less than UPDATED_NAM
        defaultDetaiShouldBeFound("nam.lessThan=" + UPDATED_NAM);
    }

    @Test
    @Transactional
    public void getAllDetaisByNamIsGreaterThanSomething() throws Exception {
        // Initialize the database
        detaiRepository.saveAndFlush(detai);

        // Get all the detaiList where nam is greater than DEFAULT_NAM
        defaultDetaiShouldNotBeFound("nam.greaterThan=" + DEFAULT_NAM);

        // Get all the detaiList where nam is greater than SMALLER_NAM
        defaultDetaiShouldBeFound("nam.greaterThan=" + SMALLER_NAM);
    }
    ...
    public void getAllDetaisByNhansuIsEqualToSomething() throws Exception {
        ...
        // Get all the detaiList where nhansu equals to DEFAULT_NHANSU
        defaultDetaiShouldBeFound("nhansu.equals=" + DEFAULT_NHANSU);

        // Get all the detaiList where nhansu equals to UPDATED_NHANSU
        defaultDetaiShouldNotBeFound("nhansu.equals=" + UPDATED_NHANSU);
    }

    @Test
    @Transactional
    public void getAllDetaisByNhansuIsNotEqualToSomething() throws Exception {
        // Initialize the database
        detaiRepository.saveAndFlush(detai);

        // Get all the detaiList where nhansu not equals to DEFAULT_NHANSU
        defaultDetaiShouldNotBeFound("nhansu.notEquals=" + DEFAULT_NHANSU);

        // Get all the detaiList where nhansu not equals to UPDATED_NHANSU
        defaultDetaiShouldBeFound("nhansu.notEquals=" + UPDATED_NHANSU);
    }

    @Test
    @Transactional
    public void getAllDetaisByNhansuIsInShouldWork() throws Exception {
        // Initialize the database
        detaiRepository.saveAndFlush(detai);

        // Get all the detaiList where nhansu in DEFAULT_NHANSU or UPDATED_NHANSU
        defaultDetaiShouldBeFound("nhansu.in=" + DEFAULT_NHANSU + "," + UPDATED_NHANSU);

        // Get all the detaiList where nhansu equals to UPDATED_NHANSU
        defaultDetaiShouldNotBeFound("nhansu.in=" + UPDATED_NHANSU);
    }

    @Test
    @Transactional
    public void getAllDetaisByNhansuIsNullOrNotNull() throws Exception {
        // Initialize the database
        detaiRepository.saveAndFlush(detai);

        // Get all the detaiList where nhansu is not null
        defaultDetaiShouldBeFound("nhansu.specified=true");

        // Get all the detaiList where nhansu is null
        defaultDetaiShouldNotBeFound("nhansu.specified=false");
    }
                @Test
    @Transactional
    public void getAllDetaisByNhansuContainsSomething() throws Exception {
        // Initialize the database
        detaiRepository.saveAndFlush(detai);

        // Get all the detaiList where nhansu contains DEFAULT_NHANSU
        defaultDetaiShouldBeFound("nhansu.contains=" + DEFAULT_NHANSU);

        // Get all the detaiList where nhansu contains UPDATED_NHANSU
        defaultDetaiShouldNotBeFound("nhansu.contains=" + UPDATED_NHANSU);
    }

    @Test
    @Transactional
    public void getAllDetaisByNhansuNotContainsSomething() throws Exception {
        // Initialize the database
        detaiRepository.saveAndFlush(detai);

        // Get all the detaiList where nhansu does not contain DEFAULT_NHANSU
        defaultDetaiShouldNotBeFound("nhansu.doesNotContain=" + DEFAULT_NHANSU);

        // Get all the detaiList where nhansu does not contain UPDATED_NHANSU
        defaultDetaiShouldBeFound("nhansu.doesNotContain=" + UPDATED_NHANSU);
    }
    ...
    @Test
    @Transactional
    public void getAllDetaisByDetaitobaibaoIsEqualToSomething() throws Exception {
        // Initialize the database
        detaiRepository.saveAndFlush(detai);
        Detaitobaibao detaitobaibao = DetaitobaibaoResourceIT.createEntity(em);
        em.persist(detaitobaibao);
        em.flush();
        detai.addDetaitobaibao(detaitobaibao);
        detaiRepository.saveAndFlush(detai);
        Long detaitobaibaoId = detaitobaibao.getId();

        // Get all the detaiList where detaitobaibao equals to detaitobaibaoId
        defaultDetaiShouldBeFound("detaitobaibaoId.equals=" + detaitobaibaoId);

        // Get all the detaiList where detaitobaibao equals to detaitobaibaoId + 1
        defaultDetaiShouldNotBeFound("detaitobaibaoId.equals=" + (detaitobaibaoId + 1));
    }
    ...
    public void updateDetai() throws Exception {
        ...
        assertThat(testDetai.getNam()).isEqualTo(UPDATED_NAM);
        ...
        assertThat(testDetai.getNhansu()).isEqualTo(UPDATED_NHANSU);
