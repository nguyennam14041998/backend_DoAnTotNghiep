...
@JsonIgnoreProperties(value = {"nhansuthamgias","nhansutobaibaos"})
public class Nhansu implements Serializable {
    ...
    public Nhansu namsinh(Integer namsinh) {
    ...
    public Nhansu nhansutobaibaos(Set<Nhansutobaibao> nhansutobaibaos) {
        this.nhansutobaibaos = nhansutobaibaos;
        return this;
    }

    public Nhansu addNhansutobaibao(Nhansutobaibao nhansutobaibao) {
        this.nhansutobaibaos.add(nhansutobaibao);
        nhansutobaibao.setNhansu(this);
        return this;
    }

    public Nhansu removeNhansutobaibao(Nhansutobaibao nhansutobaibao) {
        this.nhansutobaibaos.remove(nhansutobaibao);
        nhansutobaibao.setNhansu(null);
        return this;
    }
