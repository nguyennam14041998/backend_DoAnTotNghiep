...
public class Danhsachbaibao implements Serializable {
    ...
    @OneToMany(mappedBy = "danhsachbaibao")
    @Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
    private Set<Nhansutobaibao> nhansutobaibaos = new HashSet<>();

    @OneToMany(mappedBy = "danhsachbaibao")
    @Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
    private Set<Detaitobaibao> detaitobaibaos = new HashSet<>();
    ...
    public Set<Nhansutobaibao> getNhansutobaibaos() {
        return nhansutobaibaos;
    }

    public Danhsachbaibao nhansutobaibaos(Set<Nhansutobaibao> nhansutobaibaos) {
        this.nhansutobaibaos = nhansutobaibaos;
        return this;
    }

    public Danhsachbaibao addNhansutobaibao(Nhansutobaibao nhansutobaibao) {
        this.nhansutobaibaos.add(nhansutobaibao);
        nhansutobaibao.setDanhsachbaibao(this);
        return this;
    }

    public Danhsachbaibao removeNhansutobaibao(Nhansutobaibao nhansutobaibao) {
        this.nhansutobaibaos.remove(nhansutobaibao);
        nhansutobaibao.setDanhsachbaibao(null);
        return this;
    }

    public void setNhansutobaibaos(Set<Nhansutobaibao> nhansutobaibaos) {
        this.nhansutobaibaos = nhansutobaibaos;
    }

    public Set<Detaitobaibao> getDetaitobaibaos() {
        return detaitobaibaos;
    }

    public Danhsachbaibao detaitobaibaos(Set<Detaitobaibao> detaitobaibaos) {
        this.detaitobaibaos = detaitobaibaos;
        return this;
    }

    public Danhsachbaibao addDetaitobaibao(Detaitobaibao detaitobaibao) {
        this.detaitobaibaos.add(detaitobaibao);
        detaitobaibao.setDanhsachbaibao(this);
        return this;
    }

    public Danhsachbaibao removeDetaitobaibao(Detaitobaibao detaitobaibao) {
        this.detaitobaibaos.remove(detaitobaibao);
        detaitobaibao.setDanhsachbaibao(null);
        return this;
    }

    public void setDetaitobaibaos(Set<Detaitobaibao> detaitobaibaos) {
        this.detaitobaibaos = detaitobaibaos;
    }
