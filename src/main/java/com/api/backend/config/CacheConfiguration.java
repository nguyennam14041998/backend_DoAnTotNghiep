...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            createCache(cm, com.api.backend.domain.Detaitobaibao.class.getName());
            ...
            createCache(cm, com.api.backend.domain.Nhansu.class.getName() + ".nhansutobaibaos");
            ...
            createCache(cm, com.api.backend.domain.Detai.class.getName() + ".detaitobaibaos");
            ...
            createCache(cm, com.api.backend.domain.Danhsachbaibao.class.getName() + ".detaitobaibaos");
            createCache(cm, com.api.backend.domain.Danhsachbaibao.class.getName() + ".nhansutobaibaos");
            createCache(cm, com.api.backend.domain.Nhansutobaibao.class.getName());
